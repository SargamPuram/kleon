...
const MySQLPage = () => {
    ...
    const handleSubmit = async () => {
        try {
            const res: any = await axios.post('../api/generate_sql/mysql', { prompt, dialect: 'mysql' }, {
                headers: {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-600 via-blue-500 to-pink-500 p-4">
            <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-full max-w-xl">
                <h1 className="text-3xl font-bold mb-6 text-center text-white">Enter your MySQL query</h1>
                <div className="mb-4">
                    <textarea
